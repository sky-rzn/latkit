 ...
 * parser summary.
 *
 *   lkt_queries [--proto pg|mysql|http] [--http-user basic] [--quiet]
 *              [--metrics] FILE.lkt...
 *
 ...
 * produces, over the same registry the live agent runs). Exit is nonzero only
 * when a file fails to replay; the counters are diagnostics — the expectation
 * tables live in the acceptance scripts (queries_traces.sh,
